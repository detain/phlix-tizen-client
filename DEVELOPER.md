...
Pinned dependencies: `@phlix/ui` `github:detain/phlix-ui#v0.98.33`, `@phlix/contracts` `#v0.2.0`. Peer runtime deps: Vue 3, Pinia, vue-router. Toolchain: Vite + `@vitejs/plugin-vue`, Vitest + jsdom + `@vue/test-utils`, flat ESLint, `vue-tsc`.
